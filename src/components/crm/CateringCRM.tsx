                      ...
                      <tr key={quo.id} className="border-b border-slate-100 hover:bg-[#FAF7F2]/50 transition-colors">
                        ...
                        <td className="p-4">
                          <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold ${
                            quo.status === "Approved" || quo.status === "accepted" ? "bg-emerald-100 text-emerald-800" :
...
// ─────────────────────────────────────────────────────────────────────────────
const IMAGE_SLOTS = [
  { key: "hero_bg",        label: "Homepage Hero Banner",        hint: "Full-width hero background image (recommended 1920×900)" },
  { key: "about_banner",   label: "About Us Page Banner",        hint: "About page header (recommended 1200×500)" },
  { key: "gallery_1",      label: "Gallery Image 1",             hint: "Gallery photo (square, min 800×800)" },
  { key: "gallery_2",      label: "Gallery Image 2",             hint: "Gallery photo" },
  { key: "gallery_3",      label: "Gallery Image 3",             hint: "Gallery photo" },
  { key: "gallery_4",      label: "Gallery Image 4",             hint: "Gallery photo" },
  { key: "gallery_5",      label: "Gallery Image 5",             hint: "Gallery photo" },
  { key: "gallery_6",      label: "Gallery Image 6",             hint: "Gallery photo" },
  { key: "service_wedding",  label: "Wedding Services Card",     hint: "Wedding catering card image" },
  { key: "service_corp",     label: "Corporate Events Card",     hint: "Corporate catering card image" },
  { key: "service_birthday", label: "Birthday/Celebration Card", hint: "Celebration catering card image" },
  { key: "package_veg",    label: "Veg Package Card Banner",     hint: "Veg menu package header" },
  { key: "package_nonveg", label: "Non-Veg Package Card Banner", hint: "Non-veg menu package header" },
  { key: "logo",           label: "Company Logo",                hint: "Logo shown in header and invoices (PNG transparent recommended)" },
];
            ...
            <div key={slot.key} className="bg-white rounded-2xl border border-amber-900/10 shadow-sm overflow-hidden flex flex-col">
              ...
              <div className="p-4 flex flex-col gap-2 flex-1">
                ...
                <label className="mt-auto cursor-pointer">
                  ...
                  />
                  <span className={`flex items-center justify-center gap-1.5 w-full py-2 rounded-xl text-xs font-bold transition-all ${
                    isUploading
